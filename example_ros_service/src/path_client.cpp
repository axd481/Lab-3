...
int main(int argc, char **argv) {
    ...
    pose.position.x = 5.0; // say desired x-coord is 1
    pose.position.y = 5.0;
    pose.position.z = 0.0; // let's hope so!
    pose.orientation.x = 0.0; //always, for motion in horizontal plane
    pose.orientation.y = 0.0; // ditto
   ...
   /* pose.position.x = -5.0; // say desired x-coord is 1
    ...
    // some more poses...
    quat = convertPlanarPhi2Quaternion(1.4); // get a quaternion corresponding to this heading
    //quat = convertPlanarPhi2Quaternion(0.57);
