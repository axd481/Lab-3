...
const double g_move_speed = 0.25; // set forward speed to this value, e.g. 1m/s
const double g_spin_speed = 0.25; // set yaw rate to this value, e.g. 1 rad/s
...
int main(int argc, char **argv)
{
  ...
  ros::ServiceServer service = n.advertiseService("path_service", callback); // when woken up do callback
